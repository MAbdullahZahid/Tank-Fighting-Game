...
public class GamePanel {
    ...
    GamePanel (int lefttankhits, int righttankhits, int lefttankpowerup, int righttankpowerup,ProgressBar progressBarA,ProgressBar progressBarB){
    ...
    GamePanel ( int lefttankpowerup, int righttankpowerup){
        this.lefttankpowerup = lefttankpowerup;
        this.righttankpowerup = righttankpowerup;
        progressBarA.setProgress(1);
        progressBarB.setProgress(1);
        lefttankhits=0;
        righttankhits=0;
    }
...
//        righttankhits=0;
       ...
       defaultHeight = bounds.getHeight();
        ...
        Button split = new Button("Split Screen");
     ...
     stage.setOnCloseRequest(event -> {
        ...
        split.setOnAction(event -> {
            backgroundMusic.stop();
            SplitScreen splitScreen = new SplitScreen(lefttankhits, righttankhits, lefttankpowerup,  righttankpowerup, progressBarA, progressBarB);
        stage.close();
                splitScreen.playScreen1(stage2);
